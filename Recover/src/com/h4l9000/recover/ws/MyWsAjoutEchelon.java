...
public class MyWsAjoutEchelon {
    ...
    private static String echelon = "";
    private static String date_acces_ech = "";
    private static String mode_acces_ech = "";
    private static String page = "";
    private static String position = "";
    
    private Document docReponse = null;
    
    public MyWsAjoutEchelon (String strURL, String strNameSpace, String strMethodeWeb, String strToken, String strIdPeriode, String strAcademie, String strCorps, String strNom, String strPrenom, String strDateNaissance, String strEchelon, String strDateAccesEch, String strModeAccesEch, String strPage, String strPosition){
    	try {
			...
			mode_acces_ech = strModeAccesEch;
			page = strPage;
	        ...
	        SOAPMessage soapResponse = soapConnection.call(createSOAPRequest(token, id_periode, academie, corps, nom, prenom, date_naissance, echelon, date_acces_ech, mode_acces_ech, page, position), url);
    ...
    private static SOAPMessage createSOAPRequest(String strAuthenticatedToken, String strIdPeriode, String strAcademie, String strCorps, String strNom, String strPrenom, String strDateNaissance, String strEchelon, String strDateAccesEch, String strModeAccesEch, String strPage, String strPosition) throws Exception {
        ...
        SOAPElement soapBodyElem_var = soapBody.addChildElement("AjoutEchelon", "example");
        ...
        SOAPElement soapBodyElem_var7 = soapBodyElem_var.addChildElement("strEchelon", "example");
        soapBodyElem_var7.addTextNode(strEchelon);
        SOAPElement soapBodyElem_var8 = soapBodyElem_var.addChildElement("strDateAccesEch", "example");
        soapBodyElem_var8.addTextNode(strDateAccesEch);
        SOAPElement soapBodyElem_var9 = soapBodyElem_var.addChildElement("strModeAccesEch", "example");
        soapBodyElem_var9.addTextNode(strModeAccesEch);
        SOAPElement soapBodyElem_var10 = soapBodyElem_var.addChildElement("strPage", "example");
        soapBodyElem_var10.addTextNode(strPage);
        SOAPElement soapBodyElem_var11 = soapBodyElem_var.addChildElement("strPosition", "example");
        soapBodyElem_var11.addTextNode(strPosition);
